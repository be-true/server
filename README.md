...
- [Сервер приложения](./packages/server/README.md)
    ...
    - Раздача статических файлов
        ...
        * Генерация файлов по шаблону, кастомные функции:
            - Убрать генерацию файл из шаблона в файловую систему, а сразу грузить его в память
            - При добавлении query параметра к адресу файла, он перестает грузится
            - Описать документацию
        * Multi instance сервисов без редактировании имени
    - Документация через swagger
        * При отправке не пустого JSON зависает ответ сервера
